...
def create_optimizer(model: torch.nn.Module, optimizer_config: OptimizerConfig) -> torch.optim.Optimizer:
    """
    ...
    optimizer = torch.optim.AdamW(optim_groups, lr=optimizer_config.lr, betas=(0.9, 0.95))
    return optimizer
